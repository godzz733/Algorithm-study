...
public class Main {
    ...
    static void solve() throws IOException {
        int T = in.nextInt();
        for (int i = 0; i < T; i++) {
            int n = in.nextInt(); String t = in.next();
            if (t.equals("C")) {
                for (int j = 0; j < n-1; j++) {
                    out.print(in.next().charAt(0) - 'A' + 1 + " ");
                }
                out.println(in.next().charAt(0) - 'A' + 1);
            } else {
                for (int j = 0; j < n-1; j++) {
                    out.print(Character.toString('A' + in.nextInt() - 1) + " ");
                }
                out.println(Character.toString('A' + in.nextInt() - 1));
            }
        }
    }
