...
public class Main {
    ...
    static void solve() throws IOException {
        boolean[] p = new boolean[1500];
        boolean[] p1 = new boolean[1500];
        p[1] = true;
        p1[1] = true;
        ...
        if (p1[t]) out.println("It is a prime word.");
        else out.println("It is not a prime word.");
    }
    static BigInteger f(int a, int b){

        if (a == b) return BigInteger.valueOf(a);
        int t = (a+b) >> 1;
        return f(a,t).multiply(f(t+1,b));
    }
