...
- 처음에는 델타를 위와 왼쪽을 먼저 순회하기만 하면 된다고 생각함
- 그러나 오른쪽을 먼저 가거나 위가아니라 왼쪽을 먼저 가는 상황이 발생
- 그래서 가장 짧은 거리의 물고기 중, 가장 위와 왼쪽에 가까운 걸 찾기위해 리스트에서 sort를 해줘서 값을 찾음
[문제 링크](https://www.acmicpc.net/problem/16236) 

### 성능 요약

메모리: 116964 KB, 시간: 192 ms
