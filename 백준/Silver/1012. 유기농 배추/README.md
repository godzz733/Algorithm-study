...
## BFS 로 해결
만약 배추가 심어져있다면 그 주위를 다 돌면서 연결되있는 곳을 다 0으로 바꾸고 결과값에 1추가 -> 이걸 
### sys.setrecursionlimit(100000) 를 써주면 재귀깊이를 늘려준다. 단, 문제 사이트에서 재귀깊이를 초과하면 다른 오류를 내보냄.

[문제 링크](https://www.acmicpc.net/problem/1012) 

### 성능 요약

메모리: 303120 KB, 시간: 292 ms
