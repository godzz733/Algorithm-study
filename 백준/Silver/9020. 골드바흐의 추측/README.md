...
## 짝수는 반드시 두개의 소수의 합으로 나타난다.
기본적으로는 에라토스테네스의 체 문제이지만 골드바흐 추측을 알아야 하는데
이때 중요한 사실은 어떤 짝수 n은 n/2 에서 + - i로 나타난다. 만약 60이면 60 = 30+30, 29+31,28+32 ... (짝수이기 때문에 성립함) 이걸 기본 생각으로 만약 저 조합들 사이에 두 소수의 합이 있다면 그게 정답. 또한 절반으로 나눠 좌우로 따지므로 시간도 얼마 안걸림

[문제 링크](https://www.acmicpc.net/problem/9020) 

### 성능 요약

메모리: 140700 KB, 시간: 1668 ms
